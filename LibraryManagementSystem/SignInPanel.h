...
private:
	// screen elements
	unique_ptr<wxTextCtrl> txt_username{ new wxTextCtrl{this, wxID_ANY, "", wxPoint{35, 144}, wxSize{248, 32} } };
	unique_ptr<wxTextCtrl> txt_password{ new wxTextCtrl{this, wxID_ANY, "", wxPoint{35, 200}, wxSize{248, 32}, wxTE_PASSWORD} };
